...
# Tested with debian 12 and proxmox using https://github.com/community-scripts/ProxmoxVE
# Check if parted is installed, if not install. Then exapnd disk to use all available space.
